...
namespace ULDateTime{
	struct DateTime;
	enum DateTimeFormat{YYYYMMDD_HHmmss, YYYYMMDD_hhmmss, DDMMYYYY_hhmmss, DDMMYYYY_HHmmss, YYYYMMDDHHmmss, YYMD_Hms, YYMD_hms, DMYY_hms, DMYY_Hms, NULO};
	enum DateTimeFormat stringToDateTime(string dateTimeFormat);
	...
	string PrintFormat(DateTimeFormat format);
